...
function AboutPage() {
  ...
  return (
    <div>
        <section className="relative w-full bg-gradient-to-br from-blue-900 to-blue-700 text-white py-16 px-6 text-center">
  <h1 className="text-4xl font-bold tracking-wide">O nás</h1>
  <p className="mt-2 text-lg text-blue-100">Kdo jsme, co děláme a proč to děláme.</p>
</section>
